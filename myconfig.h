...
static const Key keys[] = {
   ...
   { ShiftMask,
        XF86XK_AudioRaiseVolume,   spawn,         SHCMD("wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 3%+; kill -44 $(pidof dwmblocks)") },
   { ShiftMask,
        XF86XK_AudioLowerVolume,   spawn,         SHCMD("wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 3%-; kill -44 $(pidof dwmblocks)") },
